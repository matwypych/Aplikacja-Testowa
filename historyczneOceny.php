...
echo '<div class ="center">
	<div style="margin-left: auto; margin-right: auto;" class = "title">
		<h2>Historyczne oceny studenta</h2>
	</div>	
</div><br><br>
<div class ="center">
	<h2>Lista Studentów</h2>
					...
					$dane= mysqli_query($conn, "SELECT DISTINCT Imie,Nazwisko,email,grupa_id,id FROM uzytkownicy where uczelnia_id= '".$_SESSION['uczelnia_id']."' and typ_konta=3 ");    
					...
					while ($wynik = mysqli_fetch_assoc($dane)) // dopóki istnieją użytkownicy ... 
						{  
							...
							echo '
							<form action="historia_student.php" method="POST">
								<div class="container">
						
									<div class="center">
									<input readonly style ="width: 5%"  type="text" name="idPost1" placeholder="nr." value="'; echo $id; echo '"required>
									<input readonly style ="width: 10%"  type="text" name="imiePost1" placeholder="Imię" value="'; echo $Imie; echo '"required>
									<input readonly style ="width: 10%"  type="text" name="nazwiskoPost1" placeholder="Nazwisko" value="' ; echo $Nazwisko; echo '" required>
									<button type="submit" id = "sprawdzanie" name="sprawdzanie" style = "background-color: green; width: 12%" type="submit"> Zobacz oceny</button>
									</div>
								</div>
							</form>';
						...
						{  
							...
							<form action="historia_student.php" method="POST">
								<div class="container">
									...
									<input readonly style ="width: 10%"  type="text" name="imiePost1" placeholder="Imię" value="'; echo $Imie; echo '"required>
									<input readonly style ="width: 10%"  type="text" name="nazwiskoPost1" placeholder="Nazwisko" value="' ; echo $Nazwisko; echo '" required>
									<button type="submit" id = "sprawdzanie" name="sprawdzanie" style = "background-color: #0066CC; width: 12%" type="submit"> Zobacz oceny</button>
									</div>
								</div>
							</form>';
